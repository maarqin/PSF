...
@NamedQueries({
    ...
    @NamedQuery(name = "ColegiadoHasUsuario.findByIdColegiadoHasUsuario", query = "SELECT c FROM ColegiadoHasUsuario c WHERE c.idColegiadoHasUsuario = :idColegiadoHasUsuario")})
